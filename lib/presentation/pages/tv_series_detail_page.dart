...
class DetailContent extends StatelessWidget {
                                          ...
                                          child: InkWell(
                                            ...
                                            child: ClipRRect(
                                              ...
                                              child: CachedNetworkImage(
                                                imageUrl:
                                                    'https://image.tmdb.org/t/p/w500${tvSeriesRec.posterPath}',
  ...
  String _showDuration(List<dynamic> runtime) {
    if (runtime.isEmpty) return '';

    final int runtimes = runtime[0];
    final int hours = runtimes ~/ 60;
    final int minutes = runtimes % 60;
